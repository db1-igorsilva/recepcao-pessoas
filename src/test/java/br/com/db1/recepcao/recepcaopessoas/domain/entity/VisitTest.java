...
public class VisitTest {
    ...
    private final static LocalTime presentationStartTime = LocalTime.parse("12:00:00");
    private final static LocalTime presentationEndTime = LocalTime.parse("14:30:00");
